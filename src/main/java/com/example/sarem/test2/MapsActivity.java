package com.example.sarem.test2;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        geoLocationBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                EditText searchText1 = (EditText) findViewById(R.id.location1);
                EditText searchText2 = (EditText) findViewById(R.id.location2);
                String search1 = searchText1.getText().toString();
                String search2 = searchText2.getText().toString();
                if (search1 != null && search2 !=null && !search1.equals("") && !search2.equals("") && first1 == true) {
                    first1 = false;
                    List<android.location.Address> addressList = null;
                    Geocoder geocoder = new Geocoder(MapsActivity.this);
                    try {
                        addressList = geocoder.getFromLocationName(search1, 1);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                    Address address1 = addressList.get(0);
                    LatLng loc1 = new LatLng(address1.getLatitude(), address1.getLongitude());
    ...
    //Hide Keyboard
    public void dismissKeyboard(Activity MapsActivity) {
        InputMethodManager imm = (InputMethodManager) MapsActivity.getSystemService(Context.INPUT_METHOD_SERVICE);
        if (null != MapsActivity.getCurrentFocus())
            imm.hideSoftInputFromWindow(MapsActivity.getCurrentFocus()
